/* =====================================================================
   Procedure: dbo.SP_Subjects_GetForStaff_ByGroup_NoNationalId_OrderDesc
   Kind: RETRIEVE
   Purpose: Get distinct subjects for staff by groupid (no NatianalId) ordered desc
            NOTE: AcademicYear is INT in Staff_Material
   Author: Eslam Ragab
   Version: 1.0.1
   CreatedOn: 2025-12-26
   ===================================================================== */
IF OBJECT_ID('dbo.SP_Subjects_GetForStaff_ByGroup_NoNationalId_OrderDesc', 'P') IS NOT NULL
    DROP PROCEDURE dbo.SP_Subjects_GetForStaff_ByGroup_NoNationalId_OrderDesc;
GO

CREATE PROCEDURE dbo.SP_Subjects_GetForStaff_ByGroup_NoNationalId_OrderDesc
    @p_faculty_code   INT,
    @p_department_id  INT,
    @p_phase_id       INT,
    @p_group_id       INT,
...
EXEC dbo.SP_Subjects_GetForStaff_ByGroup_NoNationalId_OrderDesc
    @p_faculty_code = 588,
    @p_department_id = 2773,
    @p_phase_id = 77,
    @p_group_id = 0,
    @p_class_id = 1,
    @p_academic_year = 56,   -- ❗ رقم فقط
    @p_lang = 'ar',
