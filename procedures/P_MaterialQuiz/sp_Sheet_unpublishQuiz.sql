/* =====================================================================
   Procedure: dbo.sp_UnPublishQuiz
   Kind: UPDATE
   Purpose: UnPublish quiz materials for students
...
IF OBJECT_ID('dbo.sp_UnPublishQuiz', 'P') IS NOT NULL
    DROP PROCEDURE dbo.sp_UnPublishQuiz;
GO

CREATE PROCEDURE dbo.sp_UnPublishQuiz
    -- [Input Parameters]
    @p_sheet_id BIGINT,
...
BEGIN TRY
    ...
    SET @o_message = N'Quiz is unpublished sucessfully';
END TRY
BEGIN CATCH
